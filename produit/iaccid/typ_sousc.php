    ...
    function typesous(tok){
        ...
        if (tsousc){
            if(tsousc==2){
                ...
                $("#content").load("produit/iaccid/phy/devind.php?tok="+tok);
            }else{
                $("#content").load("produit/iaccid/moral/devind.php?tok="+tok);
            }

        }else{alert("Veuillez choisir le type de souscripteur !");}
