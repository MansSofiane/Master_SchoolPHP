...
if ( isset($_REQUEST['id_demande'])) {
    ...
    $rqcpl=$bdd->prepare("update demande set etat_dem = 2 where id_demande = $id_demande ");
    $rqcpl->execute();
...
La demande que vous avez creer pour le contrat numero $sequence est accorde";
    ...
    echo "<script type="."'text/JavaScript'"."> alert("."'La demande a ete rejte avec succes !'".");  </script>"; 
