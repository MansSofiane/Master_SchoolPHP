...
<div class="widget-box">
    <ul class="quick-actions">
        ...
        <!--<li class="bg_lr"> <a onClick="aMenu1('prod','polasspta.php')"> <i class="icon-folder-open"></i>Visualiser-Contrats</a> </li>-->
    </ul>
</div>
<div class="widget-box">
...
<script language="JavaScript">
    function afrechpade(){
        ...
        $("#content").load('sp/polasspta.php?rech='+rech);
    }
    function afpagepade(page,nbpage){
        if(page >=0){
            if(page == nbpage){
                swal("Information !","Vous ete a la derniere page!","info");
            }else{$("#content").load('sp/polasspta.php?page='+page);}
