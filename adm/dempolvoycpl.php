...
<div id="content-header">
    <div id="breadcrumb"> <a class="tip-bottom"><i class="icon-home"></i> Produit</a><a class="current">Assurance-Voyage-Couple  > demande </a> </div>
</div>
<div class="widget-box">
    <ul class="quick-actions">
        <li class="bg_lo"> <a onClick="aMenu1('macc','../adash.php')"> <i class="icon-home"></i>Acceuil </a> </li>
        <li class="bg_lv"> <a onClick="aMenu1('prod','apolassvoycpl.php')"> <i class="icon-backward"></i>Precedent</a></li>
        <li class="bg_lg"> <a onClick="aMenu1('prod','apolassvoycpl.php')"> <i class="icon-folder-open"></i>Visualiser-Contrats</a> </li>
            ...
            while ($row_res=$rqtc->fetch()){  ?>
                ...
                <tr class="gradeX">
                   ...
                   <?php }
                    ...
                    if($row_res['etat_dem']!=1){
                    ?>
                    <a onClick="accorder('prod','dempolvoycpl.php','<?php echo $row_res['id_demande']; ?>', '<?php echo $row_res['cod_pol']; ?>')" title="Accorder"><i CLASS="icon-thumbs-up icon-2x" style="color:green"/></a>&nbsp;&nbsp;&nbsp;
                    <?php } 
                     if($row_res['etat_dem']!=2){
                    ?>
				    <a onClick="rejeter('prod','dempolvoycpl.php','<?php echo $row_res['id_demande']; ?>', '<?php echo $row_res['cod_pol']; ?>')" title="Rejeter"><i CLASS="icon-thumbs-down icon-2x" style="color:red"/></a>
                    <?php } ?>    
                </td>
                </tr>
            <?php } ?>
