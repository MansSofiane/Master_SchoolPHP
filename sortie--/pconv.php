...
//Requete Agence
$rqts=$bdd->prepare("SELECT *  FROM `agence` WHERE id_agence='".$row."'");
$rqts->execute();
...
$pdf->Cell(190,8,"SALAMA ASSURANCE",'0','0','C');$pdf->Ln();$pdf->Ln(100);
...
$pdf->Cell(150,8,"l’agence d'assurance de la SALAMA-ASSURANCE.",'0','0','L');$pdf->Ln();$pdf->Ln(10);
$pdf->SetFont('Arial','B',14);
...
$pdf->Cell(190,8,"La SALAMA-ASSURANCE, agence   ".$row_u['agence']."  sise à ",'0','0','L');$pdf->Ln();
...
$pdf->Cell(60,8,"L’Algérienne  Vie",'0','0','C');$pdf->Cell(65,8,"L’agence SALAMA ",'0','0','C');$pdf->Cell(65,8,"L’Agence de voyage",'0','0','C');$pdf->Ln();
