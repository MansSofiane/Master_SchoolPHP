...
?>
    ...
    <script language="JavaScript">
       ...
       function suivant(codsous,file,id_doc)
       {
           ...
           {
               //inserer les assur�s.
               xhr.open("GET","produit/voyage/groupe/phy/new_assure.php?codsous=" + codsous+"&file="+file+"&id_doc="+id_doc);
               xhr.send(null);
               //aller a destination.
               $("#content").load("produit/voyage/groupe/phy/destination.php?codsous=" + codsous+"&file="+file+"&id_doc="+id_doc);
           }
           }
           else
           {
               //supprimer  le fichier dans la base de donn�es table document.
               //inserer les assur�s.
               xhr.open("GET","produit/voyage/groupe/phy/del_doc.php?id_doc=" + id_doc);
               xhr.send(null);

               alert("Le nombre d'assur�s doit etre superieur ou egal a 10!");
           }
