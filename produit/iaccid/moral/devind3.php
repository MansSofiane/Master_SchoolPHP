...
var bool=0;
	 ...
	 //on traite ici
	 $("#content").load("produit/iaccid/moral/devind5.php?sous="+codsous+"&classe="+classe+"&periode="+periode+"&cap1="+cap1+"&cap2="+cap2+"&bool="+bool+"&tok="+tok);
	 }else{
	 cap2=0;
	 ...
	 }else{alert("Plafond de souscription atteind, le devis sera soumis a la DG-AGLIC");
	 bool=1
	  if(cap2 && isNaN(cap2) != true && cap2 <=5000 && cap2 >= 1000){
	 //on traite ici
	 $("#content").load("produit/iaccid/moral/devind5.php?sous="+codsous+"&classe="+classe+"&periode="+periode+"&cap1="+cap1+"&cap2="+cap2+"&bool="+bool+"&tok="+tok);
