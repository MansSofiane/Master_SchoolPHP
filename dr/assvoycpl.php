...
?>  
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a class="tip-bottom"><i class="icon-home"></i> Produit</a><a>Assurance-Voyage</a><a class="current">Formule-Couple</a></div>
  </div>
  <div class="widget-box">
            <ul class="quick-actions">
			  ...
			  <li class="bg_ly"> <a onClick="tarif('prod','voyage/vsimulationcpl.php')"> <i class="icon-dashboard"></i> Simulation</a> </li>
            </ul>
  </div>
   <div class="widget-box">
