            ...
            while ($row_res=$rqtc->fetch()){  ?>
                ...
                <tr class="gradeX">
                   ...
                   <?php }
                    ...
                    if($row_res['etat_dem']!=1){
                    ?>
                    <a onClick="accorder('prod','dempolvoyfam.php','<?php echo $row_res['id_demande']; ?>', '<?php echo $row_res['cod_pol']; ?>')" title="Accorder"><i CLASS="icon-thumbs-up icon-2x" style="color:green"/></a>&nbsp;&nbsp;&nbsp;
                    <?php } 
                     if($row_res['etat_dem']!=2){
                    ?>
				    <a onClick="rejeter('prod','dempolvoyfam.php','<?php echo $row_res['id_demande']; ?>', '<?php echo $row_res['cod_pol']; ?>')" title="Rejeter"><i CLASS="icon-thumbs-down icon-2x" style="color:red"/></a>
                    <?php } ?>    
                </td>
                </tr>
            <?php } ?>
