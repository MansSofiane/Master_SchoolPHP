  ...
  <div class="widget-box">
            <ul class="quick-actions">
			  <li class="bg_lo"> <a onClick="dMenu1('macc','../ddash.php')"> <i class="icon-home"></i>Acceuil </a> </li>
				<!--  <li class="bg_lb"> <a onClick="dMenu1('prod','assward.php')"> <i class="icon-folder-open"></i>Devis-En-Attente</a></li>  -->
	          <li class="bg_lg"> <a onClick="dMenu1('prod','polassward.php')"> <i class="icon-folder-open"></i>Visualiser-Contrats</a> </li>
            </ul>
  </div>
   <div class="widget-box">
...
<script language="JavaScript">
	function afrechapwar(){
        ...
        $("#content").load('adm/avpolassward.php?rech='+rech);
	}
	function afpageapwar(page,nbpage){
		if(page >=0){
			if(page == nbpage){
				alert("Vous ete a la derniere page!");
			}else{$("#content").load('adm/avpolassward.php?page='+page);}
