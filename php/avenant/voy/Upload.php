...
class Upload {
	...
	private $_error_messages = array(
		...
		'_check_size' => 'Limite de taille de fichier depassee!',
		'_check_extension' => "Le format de fichier n'est pas support�"
	);
	 ...
	 */
 	public function upload($erase_if_exists = false) {
 		...
 		if($file_exists && !$erase_if_exists) {
 			echo "<script type="."'text/JavaScript'"."> alert("."' Vous avez d�j� t�l�charg� ce fichier!'".");  </script>"; 
			//echo "<script>window.location.replace("."'files.php');</script>";
 		}
