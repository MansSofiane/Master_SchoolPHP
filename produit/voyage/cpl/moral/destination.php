                    ...
                    if(compdat(dateffet) && compdat(datech)) {
                        if (compare_deux_dates(dateffet, datech)) {
                            ...
                            if(nb_jour<=365) {
                                ...
                                xhr.open("GET", "produit/voyage/cpl/moral/devi.php?cod=" + codsous + "&option=" + option + "&duree=" + nb_jour + "&pay=" + pay + "&dateffet=" + date + "&datech=" + date2,false);
                                xhr.send(null);
                                var rp=xhr.responseText;
                                if(rp==1){alert('insertion reussi '); $("#content").load("produit/assvoycpl.php"); }else{alert('Cas non assure !');}
