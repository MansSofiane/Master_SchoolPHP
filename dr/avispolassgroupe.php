...
<div class="widget-box">
    <ul class="quick-actions">
        ...
        <li class="bg_lv"> <a onClick="dMenu1('prod','polassgroupe.php')"> <i class="icon-backward"></i>Precedent</a></li>
...
<script language="JavaScript">
    function frechatd(){
        ...
        $("#content").load('dr/avispolassgroupe.php?rech='+rech);
    }
    function fpageatd(page,nbpage,code){
        if(page >=0){
            if(page == nbpage){
                swal("Information !","Vous ete a la derniere page!","info");
            }else{$("#content").load('dr/avispolassgroupe.php?page='+page+'&code='+code);}
