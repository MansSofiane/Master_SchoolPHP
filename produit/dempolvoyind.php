...
$rqtc=$bdd->prepare("SELECT * FROM `policew` as p,`demande` as d,`utilisateurs` as u, document as doc WHERE p.cod_pol = d.cod_pol and d.id_user = u.id_user and doc.id_demande = d.id_demande and d.is_avenant = False and u.id_user = $id_user and p.`cod_pol`='$code' order by d.id_demande DESC");
$rqtc->execute();
$nbe = $rqtc->rowCount();
$nbpage=ceil($nbe/7);
?>
