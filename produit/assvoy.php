...
?>  
  ...
  <div class="widget-box">
            <ul class="quick-actions">
			  ...
			  <li class="bg_ls"> <a onClick="Menu1('prod','assvoyind.php')"> <i class="icon-user"></i>F-Individuelle</a></li>
			  <li class="bg_lb"> <a onClick="Menu1('prod','assvoycpl.php')"> <i class="icon-user"></i>F-Couple</a> </li>
	          <li class="bg_ly"> <a onClick="Menu1('prod','assvoyfam.php')"> <i class="icon-user"></i>F-Famille</a> </li>
			  <li class="bg_lg"> <a onClick="Menu1('prod','assvoygrp.php')"> <i class="icon-user"></i>F-Groupe</a> </li>
            </ul>
  </div>
   <div class="widget-box">
