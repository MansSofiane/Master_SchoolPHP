...
tel=document.getElementById("telsous").value;
	 ...
	 if(civilite && nom &&  adr && reponse){
		...
		xhr.open("GET", "produit/iaccidg/moral/nsous.php?civs="+civilite+"&noms="+nom+"&prenoms="+prenom+"&adrs="+adr+"&ages="+age+"&dnaiss="+date2+"&mails="+mail+"&tels="+tel+"&rps="+reponse, false);
        xhr.send(null);
        $("#content").load("produit/iaccidg/moral/importerfile.php");
