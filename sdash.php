   ...
   <div id="content-header">
    ...
    <div class="widget-box">
            ...
            <ul class="quick-actions">
			  <li class="bg_lh"> <a onClick="sMenu1('prod','assvoy.php')"> <i class="icon-folder-open"></i>A-Voyage</a></li>
		      <li class="bg_ls"> <a onClick="sMenu1('prod','polasstd.php')"> <i class="icon-folder-open"></i>T-Deces</a> </li>
			  <li class="bg_ly"> <a onClick="sMenu1('prod','polasscim.php')"> <i class="icon-folder-open"></i>A-D-Emprunteur</a> </li>
			  <li class="bg_lg"> <a onClick="sMenu1('prod','assiacc.php')"> <i class="icon-folder-open"></i>I-Accident</a> </li>
			  <li class="bg_lo"> <a onClick="sMenu1('prod','polassward.php')"> <i class="icon-folder-open"></i>C-S-Warda</a> </li>
			  <li class="bg_lb"> <a onClick="sMenu1('mstat','stat.php')"> <i class="icon-bar-chart"></i>E-Production</a> </li>
        <li class="bg_lo"> <a onClick="sMenu1('prod','polassgroupe.php')"> <i class="icon-folder-open"></i>Groupe</a> </li>
        <li class="bg_lm"> <a onClick="sMenu1('prod','polasspta.php')"> <i class="icon-folder-open"></i>PTA</a> </li>
			</ul>
	 </div>	
 <div class="widget-box">
