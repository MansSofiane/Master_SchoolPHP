...
?>  
  ...
  <div class="widget-box">
            <ul class="quick-actions">
			  ...
			  <li class="bg_ls"> <a onClick="Menu('prod','php/tarif/atarif.php')"> <i class="icon-folder-open"></i>Devis</a> </li>
	          <li class="bg_lg"> <a href=""> <i class="icon-folder-open"></i>Contrats</a> </li>
			  <li class="bg_ly"> <a onClick="Menu('prod','php/tarif/vsimulationconso.php')"> <i class="icon-dashboard"></i> Simulation</a> </li>
            </ul>
  </div>
   <div class="widget-box">
