...
// Garanties
		...
		$pdf->Ln();
		if ($row_sous['cod_opt'] < 23) {//ON EST DANS L OPTION CLASSIC=22
...
// Le Tarif !!!!!
		...
		$pdf->Cell(50, 5, ' Droit de timbre ', '1', '0', 'C', '1');$pdf->Cell(50, 5, ' Montant à Payer (DA) ', '1', '0', 'C', '1');
		$pdf->Ln();
		$pdf->SetFillColor(255, 255, 255);
		$pdf->SetFont('Arial', 'B', 8);
...
//Deuxieme partie
		...
		$x = $pdf->GetX();
		$y = $pdf->GetY();
		if($row_sous['dat_val']>='2021-06-20')
		{
