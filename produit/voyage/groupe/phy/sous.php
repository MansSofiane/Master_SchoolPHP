            ...
            if(civilite && nom && prenom && adr ){
                if(verifdate1(datnais)){
                    ...
                    if(age>=18){
                        ...
                        xhr.open("GET","produit/voyage/groupe/phy/new_sous.php?civ="+civilite+"&nom="+nom+"&prenom="+prenom+"&adr="+adr+"&mail="+mail+"&tel="+tel+"&nbassur="+nbassur+"&age="+age+"&dnais="+datnaisen,false);
                        xhr.send(null);
                        $("#content").load("produit/voyage/groupe/phy/charger_assur.php?nbassur="+nbassur);
