...
<div class="widget-box">
    <ul class="quick-actions">
        ...
        <li class="bg_lv"> <a onClick="aMenu1('prod','apolvoyind.php')"> <i class="icon-backward"></i>Precedent</a></li>
        <li class="bg_lg"> <a onClick="aMenu1('prod','apolvoyind.php')"> <i class="icon-folder-open"></i>Visualiser-Contrats</a> </li>
...
<script language="JavaScript">
    function frechapconso(){
        ...
        $("#content").load('adm/avpolvoyind.php?rech='+rech);
    }
    function fpageapconso(page,nbpage,code){
        if(page >=0){
            if(page == nbpage){
                alert("Vous ete a la derniere page!");
            }else{$("#content").load('adm/avpolvoyind.php?page='+page+'&code='+code);}
