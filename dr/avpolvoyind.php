...
<div class="widget-box">
    <ul class="quick-actions">
        ...
        <li class="bg_lv"> <a onClick="dMenu1('prod','apolvoyind.php')"> <i class="icon-backward"></i>Precedent</a></li>
    </ul>
</div>
<div class="widget-box">
...
<script language="JavaScript">
    function frechapconso(){
        ...
        $("#content").load('dr/avpolvoyind.php?rech='+rech);
    }
    function fpageapconso(page,nbpage,code){
        if(page >=0){
            if(page == nbpage){
                alert("Vous ete a la derniere page!");
            }else{$("#content").load('dr/apolvoyind.php?page='+page+'&code='+code);}
