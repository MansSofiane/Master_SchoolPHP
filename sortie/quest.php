...
$pdf->Cell(190,8,'Réponse au Questionnaire-Assurance ADE-TD','0','0','C');$pdf->Ln();
...
$pdf->Cell(40,5,'Réponse-7','1','0','L','1');$pdf->Cell(150,5,"".$row_r['r7']."",'1','0','C');$pdf->Ln();
$pdf->Cell(40,5,'Réponse-8','1','0','L','1');$pdf->Cell(150,5,"".$row_r['r8']."",'1','0','C');$pdf->Ln();
$pdf->Cell(40,5,'Réponse-9','1','0','L','1');$pdf->Cell(150,5,"".$row_r['r9']."",'1','0','C');$pdf->Ln();
