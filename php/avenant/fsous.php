...
function msous(code,sous,rp,page) {
  ...
  {//Souscripteur et assur�
    var noma = document.getElementById("mnoms").value;
    var pnoma = document.getElementById("mpnoms").value;
    var maila = document.getElementById("mmails").value;
    var adra = document.getElementById("madrs").value;
    var tela = document.getElementById("mtels").value;
    var cod_sousa = '<?php echo $cod_sousa;?>';
    alert ("noma="+noma+"prenoma="+ pnoma +"adr=" +adrs);
