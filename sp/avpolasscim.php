...
?>  
  ...
  <div class="widget-box">
	        ...
	        <!--  <li class="bg_lb"> <a onClick="dMenu1('prod','asscim.php')"> <i class="icon-folder-open"></i>Devis-En-Attente</a></li> -->
	          <li class="bg_lg"> <a onClick="sMenu1('prod','polasscim.php')"> <i class="icon-folder-open"></i>Visualiser-Contrats</a> </li>
            </ul>
  </div>
   <div class="widget-box">
