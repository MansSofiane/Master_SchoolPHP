<?php session_start();
if ($_SESSION['loginsal'] && $_SESSION['Role'] == "dr"){
}
else {
  ...
  <ul class="nav">
   <!--
    ...
    <li  class="dropdown" id="profile-messages2" ><a data-toggle="dropdown" data-target="#profile-messages2" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Bienvenue- <?php echo $_SESSION['nomsal']?></span><b class="caret"></b></a>
      <ul class="dropdown-menu">
        <li><a onClick="Menu('macc','php/cmpt/dcmpt.php')"><i class="icon-user"></i> Compte</a></li>
          <li class="divider"></li>
...
<div id="sidebar">
   <ul><input type="hidden" id="datsys" value="<?php echo $datesys; ?>"/>
    <li  id="macc" class="active"><a onClick="dMenu1('macc','../ddash.php')"><i class="icon icon-home"></i> <span>Acceuil</span></a> </li>
	<!-- <li id="param" class="submenu"> <a><i class="icon icon-cog"></i> <span>Parametres</span> <span class="label label-important">3</span></a>
	 ...
	 <li id="prod" class="submenu"> <a><i class="icon icon-th-list"></i> <span>Produits-Assurance</span> <span class="label label-important">5</span></a>
      <ul>
        <li><a onClick="dMenu1('prod','assvoy.php')">&nbsp;&nbsp;&nbsp;&nbsp;Assurance-Voyage</a></li>
		<li><a onClick="dMenu1('prod','polasstd.php')">&nbsp;&nbsp;&nbsp;&nbsp;Temporaire-Deces</a></li>
		<li><a onClick="dMenu1('prod','polasscim.php')">&nbsp;&nbsp;&nbsp;&nbsp;A-Deces-Emprunteur</a></li>
		<li><a onClick="dMenu1('prod','assiacc.php')">&nbsp;&nbsp;&nbsp;&nbsp;Individuel-Accident</a></li>
       <!-- <li><a onClick="Menu1('prod','assccon.php')">&nbsp;&nbsp;&nbsp;&nbsp;ADE-consommation</a></li>-->
		<li><a onClick="dMenu1('prod','polassward.php')">&nbsp;&nbsp;&nbsp;&nbsp;Cancer du Sein Warda</a></li>
      </ul>
    </li>
	<!--  
    ...
    <li id="mged"><a onClick="Menu1('mged','ged.html')"><i class="icon icon-file"></i> <span>Documents</span></a></li>-->
	   ...
	   <ul>
        <li> <a onClick="dMenu1('mstat','stat.php')"><span>Etat-PDF</span></a> </li> 
	    <li> <a onClick="dMenu1('mstat','astatex.php')"><span>Etat-EXCEL</span></a> </li> 
      </ul>
	  </li> 
...
<!--main-container-part-->
<div id="content">
<script>$("#content").load('ddash.php');</script>
</div>
</body>
</html>
...
function dMenu1(id,page) {
document.getElementById('macc').setAttribute("class", "hover");
document.getElementById('mstat').setAttribute("class", "hover");
document.getElementById('prod').setAttribute("class", "hover");
document.getElementById(id).setAttribute("class", "active");
$("#content").load('dr/'+page);
}
function aform(page) {
...
$("#content").load('dr/'+page+'?code='+codepol+'&s='+sequence);
}
